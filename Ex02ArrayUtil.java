...
public class Ex02ArrayUtil {
    public static void main(String[] args) {
        ...
        // 2. contains()
        System.out.println("ArrayUtil.contain(arr,3): " + ArrayUtil.contains(arr, 3));
        System.out.println("ArrayUtil.contain(arr,30): " + ArrayUtil.contains(arr, 30));
        System.out.println();
